...
@section('page_title', '| Add Live Match')
...
<form action="{{ route('live_matches.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
    @csrf
    @method('POST')
        ...
        <div class="col-12 col-xl-12 stretch-card">
            <div class="row flex-grow-1">
                <div class="col-md-12 stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="mb-3">Add New <span style="color: #0C32DC;">Live Match</span></h3>
                            <hr>
                            <div class="row">
                                <div class="col-sm-12">
                                ...
                                <div class="col-sm-4">
                                    <div class="mb-3">
                                        ...
                                        <input id="datepicker" type="text" name="match_time" class="form-control" value="{{ old('match_time') }}" required>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="mb-3">
