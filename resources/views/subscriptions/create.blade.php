...
@section('page_title', '| Add Subscription')
		...
		<div class="col-12 col-xl-12 stretch-card">
			<div class="row flex-grow-1">
				<div class="col-md-6 mb-3">
					<div class="card">
						<div class="card-body">
							<h3 class="mb-3">Add New <span style="color: #0C32DC;">Subscription</span></h3>
							<hr>
							<div class="row">
								<div class="col-md-12">
									<div class="mb-3">
									...
									<div class="row field_group my-2">
										<div class="col-md-12">
											<div class="form-group text-right">
												<button style="padding: 0px 8px;" class="btn btn-danger remove-row btn-sm text-white">-</button>
											</div>
										</div>
										<div class="col-md-12">
											<div class="mb-3">
