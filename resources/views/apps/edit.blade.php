...
@section('page_title', '| Edit App')

@section('content')
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}"><i class='fas fa-home text-muted'></i></a></li>
        <li class="breadcrumb-item"> <a class="text-muted" href="{{ route('apps.index') }}">App</a></li>
    ...
    <div class="col-12 col-xl-12 stretch-card">
        <div class="row flex-grow-1">
            <div class="col-md-12 stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h3 class="mb-3">Edit <span style="color: #0C32DC;">App</span></h3>
                        <hr>
                        <form action="{{ route('apps.update', $app->id) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('app_name') is-invalid @enderror" name="app_name" value="{{ $app->app_name }}" required>
                                        @error('app_name')
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('app_unique_id') is-invalid @enderror" name="app_unique_id" value="{{ $app->app_unique_id }}" readonly required>
                                        @error('app_unique_id')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-sm-12 {{ $app->app_logo_url ? '' : 'd-none' }}">
                                    <div class="mb-3">
                                        <label class="form-label">Image Url</label>
                                        <input type="url" class="form-control" name="app_logo_url" value="{{ $app->app_logo_url }}">
                                    </div>
                                </div><!-- Col -->
                                <div class="col-sm-12 {{ $app->app_logo ? '' : 'd-none' }}">
                                    <div class="mb-3">
                                ...
                                <div class="col-sm-6 fcm d-none">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="firebase_server_key" class="form-control" value="{{ $app->firebase_server_key }}" disabled required>
                                    </div>
                                </div><!-- Col -->
                                <div class="col-sm-6 fcm d-none">
                                    <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control" name="support_mail" value="{{ $app->support_mail }}">
                                    </div>
                                </div><!-- Col -->
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        <label class="form-label">From Mail</label>
                                        <input type="email" class="form-control" name="from_mail" value="{{ $app->from_mail }}">
                                    </div>
                                </div><!-- Col -->
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control smtp select2" name="smtp_encryption" data-selected="{{ $app->smtp_encryption }}">
                                ...
                                <div class="col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select select2" name="status" required data-selected="{{ $app->status }}">
...
<script>
    ...
    $('[name=app_logo_type]').on('change', function() {
        ...
        if($(this).val() == 'url'){
            ...
            $('[name=app_logo]').closest('.col-sm-12').removeClass('d-none');
