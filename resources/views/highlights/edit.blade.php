...
<form action="{{ route('highlights.update', $highlight->id) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
    @csrf
    @method('PUT')
        ...
        <div class="col-12 col-xl-12 stretch-card">
            <div class="row flex-grow-1">
                <div class="col-md-12 stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="mb-3">Edit <span style="color: #0C32DC;">Highlight</span></h3>
                            <hr>
                            <div class="row">

                                @php
                                    $checked = '';
                                    if(counter('highlight_apps', ['highlight_id' => $highlight->id]) == counter('apps', ['status' => 1])){
                                        $checked = 'checked';
                                    }
                                @endphp
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="d-flex flex-wrap mb-3">
                                        ...
                                        @foreach (App\Models\AppModel::where('status', 1)->get() as $app)
                                            @php
                                                $checked = '';
                                                if(App\Models\HighlightApp::where('app_id', $app->id)->where('highlight_id', $highlight->id)->exists()){
                                                    $checked = 'checked';
                                                }
                                            @endphp
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control select2" name="sports_type_id" required>
                                            ...
                                            @foreach ($sports_types as $type)
                                                <option value="{{ $type->id }}" {{ $type->id === $highlight->sports_type_id ? "selected": "" }}>{{ _lang($type->sports_name) }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="match_title" class="form-control" value="{{ $highlight->match_title }}" required>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="mb-3">
                                        <label class="form-label">{{ _lang('Image Type') }}</label>
                                        <select class="form-control select2" name="cover_image_type" data-selected="{{ $highlight->cover_image_type }}">
                                ...
                                <div class="col-sm-12 d-none">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="cover_url" value="{{ $highlight->cover_url }}" >
                                    </div>
                                </div>
                                <div class="col-sm-12 {{ ($highlight->cover_image_type == 'image') ? '' : ' d-none'}}">
                                    <div class="mb-3">
                                        <label class="form-label">{{ _lang('Image') }}</label>
                                        <input type="file" class="form-control dropify" name="cover_image" data-allowed-file-extensions="png jpg jpeg PNG JPG JPEG" data-default-file="{{ $highlight->cover_image ? asset($highlight->cover_image) : '' }}">
                                    </div>
                                </div>
                                <div class="col-sm-12 d-none">
                                ...
                                <div class="col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control select2" name="status" required data-selected="{{ $highlight->status }}">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="team_one_name" class="form-control" value="{{ $highlight->team_one_name }}" required>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="mb-3">
                                        <label class="form-label">{{ _lang('Name') }}</label>
                                        <input type="text" name="team_two_name" class="form-control" value="{{ $highlight->team_two_name }}" required>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="mb-3">
                ...
                <div class="col-md-12 stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @foreach (App\Models\HighlightStreamingSource::where('highlight_id', $highlight->id)->get() as $key => $streaming_source)
...
<script>
    ...
    // Show Image/URL
    @if($highlight->cover_image_type == 'url')
        $('[name=cover_url]').parent().parent().removeClass('d-none');
        $('.cover_image').html('<img src="{{ $highlight->cover_url }}" style="width: 150px; border-radius: 10px;">');
    @elseif($highlight->cover_image_type == 'image')
    ...
    @if($highlight->team_one_image_type == 'url')
        ...
        $('.team_one_image_show').html('<img src="{{ $highlight->team_one_url }}" style="width: 150px; border-radius: 10px;">');
    ...
    @if($highlight->team_two_image_type == 'url')
        ...
        $('.team_two_image_show').html('<img src="{{ $highlight->team_two_url }}" style="width: 150px; border-radius: 10px;">');
